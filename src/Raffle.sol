...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    /**
     * @dev This is the function chainlink nodes will periodically call
     * @dev to check if it is time for a new winner to be picked
     * @param - ignored
    ...
    function checkUpkeep(bytes memory) public view returns (bool upkeepNeeded, bytes memory /* performData */ ) {
        ...
        upkeepNeeded = timeHasPassed && isOpen && hasBalance && hasPlayers; // upkeep is needed if all conditions are met
        return (upkeepNeeded, "");
    }
